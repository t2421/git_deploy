...
//GitLabからのデータを整形するためのクラス
class GitLabData extends GitData
{
    ...
    public function init()
    {
        ...
        $this->remote_repository = $this->_body['repository']['git_ssh_url'];
    }

    //余計な文字列を削除して純粋なリポジトリ名を取得する
    private function _getRepositoryName(){
        $repository_name = $this->_body['repository']['git_ssh_url'];
